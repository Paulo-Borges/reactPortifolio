    ...
    <>
      ...
      >
        ...
        <div className="flex w-[1200] gap-4">
          <div className="bg-custom-image w-[300px] h-[400px] hover:bg-position[100% 100%]">
            fylo
          </div>
          <div className="bg-custom-image1 w-[300px] h-[400px]">extension</div>
          <div className="bg-custom-image2 w-[300px] h-[400px]">inwood</div>
        </div>
      </section>
    </>
  );
